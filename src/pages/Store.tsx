    ...
    <Transition>
      <div>
        ...
        <section className="bg-[url('/images/background/bg-store.png')] bg-no-repeat bg-cover bg-bottom h-screen flex flex-col justify-center items-center pt-10">
          <div className="flex flex-row justify-center">
            <h1 className="text-5xl lg:text-6xl font-brokenConsole text-white text-center">
              INVORMATIC FESTIVAL <br /> STORE 12
            </h1>
          </div>
        ...
        <section className="bg-gradient-to-b from-[#594584] to-[#FDB5DA]">
          ...
          <div className="mt-2 font-montserrat text-white text-justify lg:text-center px-2 lg:px-32">
          ...
          <div className="flex flex-col justify-center items-center xl:flex-row gap-5 p-8">
            <div className="flex flex-col bg-[url('/images/product-store/bg-product.png')] items-center px-4 py-4 w-[360px] min-h-[400px] rounded-3xl shadow-xl">
              <div className="flex flex-col justify-center px-10 py-5 bg-[url('/images/product-store/bg.png')] rounded-3xl">
                <img src="images/product-store/shirt-back.png" alt="Kaos" />
              </div>
              <div className="flex flex-col mt-5 justify-center items-center">
                <div className="title font-brokenConsole text-3xl text-[#003150]">
                  T-Shirt IFest#12
                </div>
            ...
            <div className="flex flex-col bg-[url('/images/product-store/bg-product.png')] items-center px-4 py-4 w-[360px] min-h-[400px] rounded-3xl shadow-xl">
              <div className="flex flex-col justify-center px-10 py-5 bg-[url('/images/product-store/bg.png')] min-h-[300px] rounded-3xl">
                <img src="images/product-store/keychain.png" alt="Gantungan" />
              </div>
              <div className="flex flex-col mt-5 justify-center items-center">
                <div className="title font-brokenConsole text-3xl text-[#003150]">
                  Keychain IFest#12
            ...
            <div className="flex flex-col bg-[url('/images/product-store/bg-product.png')] items-center px-4 py-4 w-[360px] min-h-[400px] rounded-3xl shadow-xl">
              <div className="flex flex-col justify-center px-10 py-5 bg-[url('/images/product-store/bg.png')] min-h-[300px] rounded-3xl">
                <img src="images/product-store/notebook.png" alt="Notebook" />
              </div>
              <div className="flex flex-col mt-5 justify-center items-center">
                <div className="title font-brokenConsole text-3xl text-[#003150]">
                  Notebook IFest#12
            ...
            <div className="flex flex-col bg-[url('/images/product-store/bg-product.png')] items-center px-4 py-4 w-[360px] min-h-[400px] rounded-3xl shadow-xl">
              <div className="flex flex-col justify-center px-10 py-5 bg-[url('/images/product-store/bg.png')] min-h-[330px] rounded-3xl">
                <img
                  src="images/product-store/totebag-front(white).png"
                  alt="Totebag"
                />
              </div>
              <div className="flex flex-col mt-5 justify-center items-center">
