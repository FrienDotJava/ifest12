  ...
  return (
    <Transition>
      <div className="secbody">
        ...
        <section
          className="bg-[url('/images/background/bg-wdc.webp')] bg-no-repeat bg-cover bg-bottom h-screen flex flex-col justify-center items-center pt-10"
          id="sec1"
        >
        ...
        <section className="bg-gradient-to-b from-[#42B54C] to-[#9DDB59]">
          ...
          <div className="font-montserrat text-white text-justify lg:text-center px-10 lg:px-32 pb-12">
            ...
            penciptaan/perancangan sistem serta desain visual informasi digital
            yang ditampilkan dalam situs web. Web Design Competition (WDC) 2024
            mengangkat tema "Exploring Indonesia With The Power of Technology"
          </div>
          ...
          <div className="flex flex-col flex-wrap gap-2 px-10 py-4 text-center text-sm text-white justify-center lg:w-full lg:flex-row lg:gap-6 lg:px-0">
            <button
              ...
              className="items-center gap-1 font-bold rounded-full bg-[#8637C6] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat hover:scale-105 hover:shadow-[0_0px_15px_0px_#8637C6]"
            >
              Poster
            </button>
            <Dialog
            ...
            <a
              href="https://bit.ly/Pendaftaran_WDC"
              rel="noreferrer"
              target="_blank"
              className="flex justify-center gap-4 items-center font-bold rounded-full bg-[#8637C6] p-2 lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat hover:scale-105 hover:shadow-[0_0px_15px_0px_#8637C6]"
            >
          ...
          <div className="flex flex-col lg:flex-row justify-center items-start gap-20">
              ...
              <ol className="pl-6 list-outside list-decimal leading-loose">
                ...
                <li>
                  ...
                  <a
                    href="https://bit.ly/Pendaftaran_WDC"
                    target="_blank"
                    className="text-[#F4347F] hover:text-[#D0047F]"
                  >
                    {" "}
                    https://bit.ly/Pendaftaran_WDC
                  </a>
                  , pendaftaran akan dibuka mulai dari Jumat, 2 Februari 2024
                  sampai dengan Senin, 5 Maret 2024 pukul 23.59 WIB.
                </li>
                <li>
                ...
                <li>Peserta membayar biaya pendaftaran sebesar Rp50.000,00.</li>
                <li>
                ...
                <li>
                  Panitia berhak untuk mengeleminasi peserta yang tidak mematuhi
                  ketentuan di atas.
                </li>
                <li>
            ...
            >
              ...
              <ol className="pl-6 list-outside list-decimal leading-loose">
                ...
                <li>
                  Peserta dibebaskan menggunakan software apapun dalam pembuatan
                  desain.
                </li>
                ...
                <li>
                  Penilaian karya didasarkan pada kriteria berikut.
                  <ul className="list-disc list-outside pl-4">
                    <li>
                      Tampilan Layout/Antarmuka (30%): menampilkan antarmuka
                      situs web dengan struktur yang tepat.
                    </li>
                    <li>
                    ...
                    <li>
                      Daya Tarik dan Informatif (25%): dapat menciptakan daya
                      tarik dan memberikan pesan yang informatif.
                    </li>
                    <li>
                      Responsif (15%): situs web dapat diakses dengan
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between w-2/3 lg:items-end py-12 gap-12">
            ...
            <div className="order-first lg:order-none flex lg:flex-col justify-center items-center text-white font-montserrat gap-8 hover:scale-125 transition">
              <div className="flex flex-col justify-center items-center">
                ...
                />
                <div className="font-brokenConsole text-2xl lg:text-3xl py-4">
                  First
                </div>
              </div>
