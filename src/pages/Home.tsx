  ...
  return (
    <div>
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <div className="awan_animation_layer parallax" id="title">
                {" "}
              </div>
              <div className="awan_animation_layer parallax flex flex-col justify-center items-center h-screen font-brokenConsole font-bold text-3xl text-white">
                IFest #12
              </div>
              <div className="awan_animation_layer parallax mt-12 font-brokenConsole text-white bg-[url('images/pixel-button.png')] bg-contain bg-no-repeat bg-center w-36 h-12 transition-transform hover:scale-125 flex justify-center items-center cursor-pointer id='awan">
                Start
              </div>
            </ParallaxLayer>
            <ParallaxLayer offset={1} speed={0.25}>
              <div className="flex flex-col justify-start items-center h-screen bg-gradient-to-b from-[#5A99D2] from-40% via-[#A5CAE4] via-70% to-[#DBE9F5]">
                <div className="mt-12 font-brokenConsole font-bold text-3xl text-white">
                  About IFest #12
                </div>
                <div className="mt-12 font-louisGeorgeCafe text-white px-20 text-center">
                  ...
                  information with prospective participants about IFest#12 and
                  the registration process for IFest competitions. We handled
                  the entire process, from designing to deploying the website.
                  The theme of this year's Ifest is Eternal Technology : A
                  Symphony from Informatics for The Future.
                </div>
              </div>
      ...
      <div className="flex flex-col justify-start items-center h-screen bg-gradient-to-b from-[#5A99D2] from-40% via-[#A5CAE4] via-70% to-[#DBE9F5]">
        ...
        <div className="mt-12 font-louisGeorgeCafe text-white px-20 text-center">
          IFEST#12 UAJY stands for Informatics Festival. It is an annual
          festival organized by the Informatics Student Association (HIMAFORKA)
          at Atma Jaya University Yogyakarta. Our team has developed a website
          that will serve as a platform to share information with prospective
          participants about IFest#12 and the registration process for IFest
          competitions. We handled the entire process, from designing to
          deploying the website. The theme of this year's Ifest is Eternal
          Technology : A Symphony from Informatics for The Future.
        </div>
      </div>
      <div className="flex flex-col justify-start items-center h-screen bg-[#DBE9F5]">
        <div className="mt-12 flex flex-row justify-center items-center gap-4">
