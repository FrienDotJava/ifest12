  ...
  return (
    <Transition>
      <div className="secbody">
        ...
        <section className="bg-[url('images/background/bg-i2c.png')] bg-no-repeat bg-cover bg-bottom h-screen flex flex-col justify-center items-center pt-10" id="sec1">
          <div className="flex flex-row justify-center">
            <h1 className="text-6xl font-brokenConsole text-white text-center">
          ...
          <div className="flex flex-col flex-wrap gap-2 px-10 py-4 text-center text-sm text-white justify-center lg:w-full lg:flex-row lg:gap-6 lg:px-0">
            <div className="items-center gap-1 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">Rp100.000</div>
            <div className="items-center gap-1 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">SMA / Sederajat</div>
            <div className="items-center gap-1 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">MAX. 3 orang</div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-b from-[#531C9C] to-[#8637C6]">
          ...
          <div className="flex justify-center items-center gap-3 pt-12 pb-4">
            ...
            <h2 className="font-brokenConsole font-bold text-3xl text-white">About I2C</h2>
            <img src="images/star.png" alt="star-img" className="w-12"/>
          </div>

          <div className="font-montserrat text-white text-center px-32 pb-12">
          Innovative Informatics Contest adalah sebuah kompetisi yang menguji 
          kemampuan peserta dalam menyusun ide untuk memecahkan berbagai permasalahan 
          yang ada di dunia dengan memberikan solusi melalui pendekatan Teknologi Informasi, 
          yang dapat berbentuk aplikasi, web, dan juga IoT. Pada tahun ini, I2C mengangkat tema 
          "A Step Closer to Perfection" dengan harapan peserta dapat membuat produk inovatif 
          yang dapat membantu pengguna menguasai berbagai disiplin ilmu, baik akademik maupun 
          nonakademik, melalui media Teknologi Informasi.
          </div>
          ...
          <div className="flex flex-col flex-wrap gap-2 px-10 py-4 text-center text-sm text-white justify-center lg:w-full lg:flex-row lg:gap-6 lg:px-0">
            <button onClick={() => setOpenPoster(true)} className="items-center gap-1 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">Poster</button>
            <Dialog
            ...
            <button onClick={() => setOpenRulebook(true)} className="items-center gap-1 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">Rule Book</button>
            <Dialog
                className="relative z-50"
        ...
        <section className="bg-gradient-to-b from-[#8637C6] via-[#BE8ADE] to-[#E5D2F2]">
          <div className="flex justify-center items-center gap-3 pt-12 pb-4">
            <img src="images/star.png" alt="star-img" className="w-12"/>
            <h2 className="font-brokenConsole font-bold text-3xl text-[#F4347F]">Ketentuan I2C</h2>
            <img src="images/star.png" alt="star-img" className="w-12"/>
          </div>

          <div className="flex justify-center items-start gap-20">
            <div className="bg-white h-fit w-2/5 p-8 rounded-2xl font-montserrat" style={{boxShadow: "2px 2px 10px rgb(255, 255, 255)"}}>
              ...
              <ol className="pl-6 list-outside list-decimal leading-loose">
                ...
                <li>
                  Setiap tim tidak boleh mengganti anggota yang sudah terdaftar pada 
                ...
                <li>
                  Pengembalian (refund) biaya pendaftaran tidak dapat dilakukan dalam 
                  keadaan apa pun.
                </li>
                <li>
                ...
                <li>
                  Setiap guru dapat membimbing lebih dari satu (1) tim, selama tim 
        ...
        <section className="bg-gradient-to-b from-[#E5D2F2] to-[#704BDA] h-screen flex flex-col justify-center items-center">
          <div className="flex justify-center items-center gap-3 pt-12 pb-4">
            <img src="images/star.png" alt="star-img" className="w-12"/>
            <h2 className="font-brokenConsole font-bold text-3xl text-[#F4347F]">TIMELINE I2C</h2>
            <img src="images/star.png" alt="star-img" className="w-12"/>
          </div>
          
          <div className="p-12 rounded-xl bg-[#E5D2F2]">
            <Timeline>
              {timelineItems.map((item, index) => {
                return(
                  <TimelineItem className="pt-8">
                    ...
                    <TimelineBody className="pb-8">
                      <Typography variant="small" color="gray" className="font-normal text-[#704BDA] font-montserrat font-bold" placeholder={undefined}>
                        {item.date}
                      </Typography>
                    </TimelineBody>
                  </TimelineItem>
        ...
        <section className="bg-gradient-to-b from-[#704BDA] to-[#552E91] h-screen flex flex-col justify-center items-center">
          <div className="flex justify-center items-center gap-3 pt-12 pb-4">
            <img src="images/star.png" alt="star-img" className="w-12"/>
            <h2 className="font-brokenConsole font-bold text-5xl text-white">PRIZEPOOL</h2>
            <img src="images/star.png" alt="star-img" className="w-12"/>
          </div>
          <div className="text-white font-montserrat text-3xl font-bold">Rp9.000.000,00</div>
          <div className="flex justify-between w-2/3 items-end py-12">
            <div className="flex flex-col justify-center items-center text-white font-montserrat hover:scale-125 transition">
              <img src="images/silver-cup.png" alt="silver-img" className="w-36"/>
            ...
            <div className="flex flex-col justify-center items-center text-white font-montserrat hover:scale-125 transition">
              <img src="images/gold-cup.png" alt="silver-img" className="w-40"/>
              <div className="font-brokenConsole text-3xl py-4">First</div>
              <div>Rp4.000.000,00</div>
              <div>Certificate</div>
              <div>Trophy</div>
            </div>
            <div className="flex flex-col justify-center items-center text-white font-montserrat hover:scale-125 transition">
              <img src="images/bronze-cup.png" alt="silver-img" className="w-36"/>
        ...
        <section className="bg-[#6b30c7] py-12" >
          <div className="flex flex-col justify-center items-center" >
            <div className="font-brokenConsole font-bold text-3xl text-white">Tertarik? Ayo Segera Daftar!</div>
            ...
            <a href="/" rel="noreferrer" target="_blank">
              <button className="flex items-center gap-4 rounded-full bg-[#F4347F] p-2 lg:flex-row lg:text-sm lg:tracking-wide px-5 py-3 font-montserrat">
        ...
        <section className="bg-gradient-to-b from-[#552E91] to-[#290265] relative ">
          <img className="absolute w-60 top-24 left-4" src="images/awan3.png" />
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="font-montserrat text-white text-center w-3/5">
          ...
          <img className="absolute w-60 top-48 right-0" src="images/awan2.png" />

          <CP event="I2C" bg="#60458A" person1="Alvin" person2="Jeany" no1="87794005230" no2="82151779891"/>
          {/* <div className="flex justify-center items-center text-white p-8">
            <div className="flex flex-col justify-center items-center bg-[#60458A] p-8 rounded-xl">
              <div className="flex gap-2 items-center">
                <div className="font-brokenConsole text-3xl">WDC</div>
                <img src="/images/computer.png" alt="computer-img" />
              </div>
              <div className="flex flex-col justify-center items-center gap-4">
                <div className="flex flex-col justify-center items-center">
                  <div className="font-montserrat text-lg">Alvin</div>
                  <div>
                    <a href="https://wa.me/6287794005230 " target="_blank">
                      <button className="flex flex-row justify-center items-center gap-2 bg-[#5ECC85] p-3 rounded-full">
                        <FaWhatsapp /> 
                        <div>087794005230</div>
                      </button>
                    </a>
                  </div>
                </div>
                <div className="flex flex-col justify-center items-center">
                  <div className="font-montserrat text-lg">Jeany</div>
                  <div>
                    <a href="https://wa.me/6282151779891 ">
                      <button className="flex flex-row justify-center items-center gap-2 bg-[#5ECC85] p-3 rounded-full">
                        <FaWhatsapp /> 
                        <div>082151779891</div>
                      </button>
                    </a>
                  </div>
                </div>
