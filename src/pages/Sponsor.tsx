...
const Sponsor: FC = () => {
  return (
    <Transition>
      <div>
        <NavBar bg1="#3483A2" bg2="#fff" fg="#fff" />
        <section className="bg-[url('/images/background/bg-sponsor.webp')] bg-no-repeat bg-cover bg-bottom h-screen flex flex-col justify-center items-center pt-10">
        ...
        <section className="bg-gradient-to-b from-[#3483A2] to-[#4AB9AE] h-fit">
          ...
          <div className="flex flex-col justify-center items-center lg:flex-row mx-20">
