  ...
  return (
    <div className="relative">
      <div className="flex flex-col justify-center items-center lg:flex-col gap-20">
        <div className="hexagon -mt-20 flex relative">
          <svg
            width="500"
            height="371"
            viewBox="0 0 609 371"
          ...
          <div className="text-white text-center lg:text-center absolute top-20 px-10 lg:px-20">
            <h2 className="mt-3 font-brokenConsole text-5xl">{name}</h2>
        ...
        <div className="-mt-72 pt-40 mb-5 flex flex-col px-6 max-w-full bg-[#B3E872] rounded-[40px] w-[400px] shadow-lg">
          <ul
            id="myList"
            ...
            {extraFeatures.map((extraFeature, index) => (
              <li className="flex" key={index}>
                <section {...getCollapseProps()}>
                  ...
                  <div className="ml-8">{extraFeature}</div>
                </section>
              </li>
            ))}
          </ul>
